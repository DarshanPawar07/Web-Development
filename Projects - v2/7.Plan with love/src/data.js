const data = [
	...
	},
	{
		id: 5,
		name: "Darjeeling",
		info: "The windy lanes of Darjeeling is often peppered with “Aiya! Kay saro chisso hau!” (Gosh, why is it so cold!) as people hunch over small fires outside shops and at street corners. A collective excitement ripples through when the sun comes out: people hurry to spread out blankets, carpets, and pickles on their roofs and balcony railings. If there is a common thread that binds all the individuals within Darjeeling (apart from their love for the Chowrastha, long walks around the Mall or gossip over hot tea), it is their love for the off-duty sun, usually masked by clouds or robbed by the cold winds that blow across the Eastern Himalayas.",
